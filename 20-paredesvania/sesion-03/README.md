...
Comuniccación entre dos dispositivos distintos.
...
1. **.vscode:** Cosas que necesita nuestro compu
2. **build:** Compilados de, no lo tocamos
3. **.gitignore:** No se comparten
4. **nombreDelArchivo.cpp:** El archivo que creamos. _(el importante)_
5. **CMakeLists.txt:** Cosas que pasan, bacan x ti.
...
Ver el primer capitulo de monty phyton.
